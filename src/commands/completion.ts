...
`);
                ...
                console.error(chalk.red(`✗ Shell non supporté : "${shell}". Les shells supportés sont "bash" et "zsh".`));
                process.exit(1);
            }
        });
    ...
    program
        ...
        .action(async (words: string[] = []) => {
            const topLevelCommands = ['auth', 'project', 'status', 'completion', 'init', 'doctor'];
