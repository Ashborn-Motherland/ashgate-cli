...
`;
                    ...
                    console.log(chalk_1.default.green('✓ Fichier .env mis à jour avec les variables ASHGATE.'));
...
`;
                    fs_1.default.writeFileSync(path_1.default.join(compDir, 'AshgatePayment.vue'), vueContent);
                    console.log(chalk_1.default.green('✓ Composant components/AshgatePayment.vue généré.'));
                }
                    ...
                    fs_1.default.appendFileSync(envPath, envVars);
                    console.log(chalk_1.default.green('✓ Fichier .env mis à jour.'));
                    const compDir = path_1.default.join(projectPath, 'components');
                    if (!fs_1.default.existsSync(compDir))
                        fs_1.default.mkdirSync(compDir, { recursive: true });
...
`;
                    fs_1.default.writeFileSync(path_1.default.join(compDir, 'AshgatePayment.tsx'), reactContent);
                    console.log(chalk_1.default.green('✓ Composant components/AshgatePayment.tsx généré.'));
                }
                else {
