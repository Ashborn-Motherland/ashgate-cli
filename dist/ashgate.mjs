...
var require_package = __commonJS({
  "node_modules/.pnpm/dotenv@17.3.1/node_modules/dotenv/package.json"(exports, module) {
    module.exports = {
      name: "dotenv",
      version: "17.3.1",
...
var require_env_options = __commonJS({
  "node_modules/.pnpm/dotenv@17.3.1/node_modules/dotenv/lib/env-options.js"(exports, module) {
    var options = {};
...
var require_cli_options = __commonJS({
  "node_modules/.pnpm/dotenv@17.3.1/node_modules/dotenv/lib/cli-options.js"(exports, module) {
...
var require_make_dir = __commonJS({
  "node_modules/.pnpm/make-dir@3.1.0/node_modules/make-dir/index.js"(exports, module) {
    "use strict";
    var fs8 = __require("fs");
    var path4 = __require("path");
    ...
    module.exports.sync = (input2, options) => {
      checkPath(input2);
      options = processOptions(options);
...
var require_xdg_basedir = __commonJS({
  "node_modules/.pnpm/xdg-basedir@4.0.0/node_modules/xdg-basedir/index.js"(exports) {
    ...
    exports.data = env2.XDG_DATA_HOME || (homeDirectory ? path4.join(homeDirectory, ".local", "share") : void 0);
    exports.config = env2.XDG_CONFIG_HOME || (homeDirectory ? path4.join(homeDirectory, ".config") : void 0);
    exports.cache = env2.XDG_CACHE_HOME || (homeDirectory ? path4.join(homeDirectory, ".cache") : void 0);
    exports.runtime = env2.XDG_RUNTIME_DIR || void 0;
    exports.dataDirs = (env2.XDG_DATA_DIRS || "/usr/local/share/:/usr/share/").split(":");
    if (exports.data) {
      exports.dataDirs.unshift(exports.data);
    }
    exports.configDirs = (env2.XDG_CONFIG_DIRS || "/etc/xdg").split(":");
    if (exports.config) {
...
var require_crypto_random_string = __commonJS({
  "node_modules/.pnpm/crypto-random-string@2.0.0/node_modules/crypto-random-string/index.js"(exports, module) {
    "use strict";
    var crypto3 = __require("crypto");
...
var require_unique_string = __commonJS({
  "node_modules/.pnpm/unique-string@2.0.0/node_modules/unique-string/index.js"(exports, module) {
    "use strict";
...
var require_configstore = __commonJS({
  "node_modules/.pnpm/configstore@5.0.1/node_modules/configstore/index.js"(exports, module) {
    "use strict";
    var path4 = __require("path");
    var os3 = __require("os");
...
function generatePKCE() {
  const verifier = base64url(crypto2.randomBytes(32));
...
`));
  ...
  const response = await axios_default.post(tokenUrl, params.toString(), {
    ...
    httpAgent: new http3.Agent({ keepAlive: false }),
    httpsAgent: new https2.Agent({ keepAlive: false })
  });
...
function registerInitCommands(program3) {
  program3.command("init").description("D\xE9tecter le projet local, configurer les cl\xE9s et installer les composants de paiement").action(async () => {
    try {
      ...
      let projectPath = cwd;
      if (fs6.existsSync(path2.join(cwd, "pubspec.yaml"))) {
        detectedType = "flutter";
      } else if (fs6.existsSync(path2.join(cwd, "Gemfile"))) {
        detectedType = "rails";
      } else if (fs6.existsSync(path2.join(cwd, "package.json"))) {
        try {
          const pkg = JSON.parse(fs6.readFileSync(path2.join(cwd, "package.json"), "utf8"));
      ...
      if (!detectedType) {
        ...
        const searchDirs = fs6.readdirSync(cwd).filter((f) => fs6.statSync(path2.join(cwd, f)).isDirectory());
        for (const dir of searchDirs) {
          const subPath = path2.join(cwd, dir);
          if (fs6.existsSync(path2.join(subPath, "pubspec.yaml"))) {
            detectedType = "flutter";
            projectPath = subPath;
            break;
          } else if (fs6.existsSync(path2.join(subPath, "package.json"))) {
            try {
              const pkg = JSON.parse(fs6.readFileSync(path2.join(subPath, "package.json"), "utf8"));
              const deps = { ...pkg.dependencies, ...pkg.devDependencies };
              if (deps.nuxt) {
                detectedType = "nuxt";
                projectPath = subPath;
      ...
      if (detectedType) {
        console.log(source_default.green(`\u2713 Projet d\xE9tect\xE9 : ${source_default.bold(detectedType.toUpperCase())} dans ${path2.relative(cwd, projectPath) || "."}`));
      } else {
...
\u26A0\uFE0F  Impossible de charger les projets depuis l'API (${err.message}).`));
      ...
      try {
        if (detectedType === "flutter") {
          ...
          const pubspecContent = fs6.readFileSync(pubspecPath, "utf8");
          if (useFedapay) {
          ...
          const libDir = path2.join(projectPath, "lib");
          const providersDir = path2.join(libDir, "providers");
          if (!fs6.existsSync(providersDir)) {
            fs6.mkdirSync(providersDir, { recursive: true });
          }
...
`;
          fs6.writeFileSync(path2.join(libDir, "ashgate_config.dart"), configContent);
...
`;
          fs6.writeFileSync(path2.join(libDir, "ashgate_payment_provider.dart"), providerBaseContent);
...
`;
            fs6.writeFileSync(path2.join(providersDir, "fedapay_provider.dart"), fedapayProviderContent);
            console.log(source_default.green("\u2713 Fichier lib/providers/fedapay_provider.dart g\xE9n\xE9r\xE9."));
          } else {
            const oldFeda = path2.join(providersDir, "fedapay_provider.dart");
            if (fs6.existsSync(oldFeda)) fs6.unlinkSync(oldFeda);
          }
          if (useStripe) {
...
`;
            fs6.writeFileSync(path2.join(providersDir, "stripe_provider.dart"), stripeProviderContent);
            console.log(source_default.green("\u2713 Fichier lib/providers/stripe_provider.dart g\xE9n\xE9r\xE9."));
          } else {
            const oldStripe = path2.join(providersDir, "stripe_provider.dart");
            if (fs6.existsSync(oldStripe)) fs6.unlinkSync(oldStripe);
          }
          if (useFeexpay) {
...
`;
            ...
            fs6.writeFileSync(path2.join(providersDir, "feexpay_provider.dart"), feexpayProviderContent);
            console.log(source_default.green("\u2713 Fichier lib/providers/feexpay_provider.dart g\xE9n\xE9r\xE9."));
          } else {
            const oldFeex = path2.join(providersDir, "feexpay_provider.dart");
            if (fs6.existsSync(oldFeex)) fs6.unlinkSync(oldFeex);
          }
          const imports = [
            "import 'package:flutter/material.dart';"
          ];
...
${webviewClass}
`;
          fs6.writeFileSync(path2.join(libDir, "ashgate_payment.dart"), orchestratorContent);
          console.log(source_default.green("\u2713 Fichier lib/ashgate_payment.dart g\xE9n\xE9r\xE9."));
          const mainDartPath = path2.join(projectPath, "lib/main.dart");
          if (fs6.existsSync(mainDartPath)) {
...
` + mainContent;
  ...
  ${runAppCall};
              ...
              fs6.writeFileSync(mainDartPath, mainContent);
...
`;
          fs6.appendFileSync(envPath, envVars);
          console.log(source_default.green("\u2713 Fichier .env mis \xE0 jour avec les variables NUXT_PUBLIC_ASHGATE."));
          const serverApiDir = path2.join(projectPath, "server", "api", "ashgate");
          if (!fs6.existsSync(serverApiDir)) fs6.mkdirSync(serverApiDir, { recursive: true });
...
`;
          fs6.writeFileSync(path2.join(serverApiDir, "checkout.post.ts"), serverNitroContent);
          console.log(source_default.green("\u2713 Route serveur server/api/ashgate/checkout.post.ts g\xE9n\xE9r\xE9e."));
          const composablesDir = path2.join(projectPath, "composables");
          if (!fs6.existsSync(composablesDir)) fs6.mkdirSync(composablesDir, { recursive: true });
...
`;
          fs6.writeFileSync(path2.join(composablesDir, "useAshgatePayment.ts"), composableContent);
          console.log(source_default.green("\u2713 Composable composables/useAshgatePayment.ts g\xE9n\xE9r\xE9."));
          const compDir = path2.join(projectPath, "components");
          if (!fs6.existsSync(compDir)) fs6.mkdirSync(compDir, { recursive: true });
...
`;
          fs6.writeFileSync(path2.join(compDir, "AshgateCheckout.vue"), vueContent);
...
`;
          ...
          const compDir = path2.join(srcDir, "components");
          const composablesDir = path2.join(srcDir, "composables");
          if (!fs6.existsSync(compDir)) fs6.mkdirSync(compDir, { recursive: true });
          if (!fs6.existsSync(composablesDir)) fs6.mkdirSync(composablesDir, { recursive: true });
...
`;
          fs6.writeFileSync(path2.join(composablesDir, "useAshgatePayment.js"), composableVue);
...
`;
          ...
          const appApiDir = path2.join(projectPath, "app", "api", "ashgate", "checkout");
          if (!fs6.existsSync(appApiDir)) fs6.mkdirSync(appApiDir, { recursive: true });
...
`;
          fs6.writeFileSync(path2.join(appApiDir, "route.ts"), nextRouteContent);
          console.log(source_default.green("\u2713 Next.js App Router Route app/api/ashgate/checkout/route.ts g\xE9n\xE9r\xE9e."));
          const hooksDir = path2.join(projectPath, "hooks");
          if (!fs6.existsSync(hooksDir)) fs6.mkdirSync(hooksDir, { recursive: true });
...
`;
          fs6.writeFileSync(path2.join(hooksDir, "useAshgatePayment.ts"), hookContent);
...
`;
          fs6.writeFileSync(path2.join(compDir, "AshgateCheckout.tsx"), reactNextComponent);
...
`;
          ...
          const srcDir = path2.join(projectPath, "src");
          const compDir = path2.join(srcDir, "components");
          const hooksDir = path2.join(srcDir, "hooks");
          if (!fs6.existsSync(compDir)) fs6.mkdirSync(compDir, { recursive: true });
          if (!fs6.existsSync(hooksDir)) fs6.mkdirSync(hooksDir, { recursive: true });
...
`;
          fs6.writeFileSync(path2.join(hooksDir, "useAshgatePayment.ts"), reactHookContent);
...
function registerUninstallCommands(program3) {
  program3.command("uninstall").description("D\xE9sinstaller compl\xE8tement Ashgate CLI et supprimer sa configuration locale").option("-y, --yes", "Confirmer automatiquement sans demander d'interaction").action(async (options) => {
    ...
    const possiblePaths = [
      ...
      path3.join(process.env.HOME || "", ".local", "bin", "ashgate")
    ];
    let removedBinary = false;
    for (const p of possiblePaths) {
      if (p && fs7.existsSync(p) && !p.includes("node_modules") && !p.endsWith("node")) {
        try {
          fs7.unlinkSync(p);
